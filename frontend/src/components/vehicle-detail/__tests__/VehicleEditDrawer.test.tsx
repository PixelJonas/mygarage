...
import { IMPERIAL_UNITS, UK_IMPERIAL_UNITS, makeDetailStats } from '../../../__tests__/factories'
...
const baseDetailStats: VehicleDetailStats = makeDetailStats({ spent_this_year: '0', year: 2024 })
