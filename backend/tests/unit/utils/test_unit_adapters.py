...
EXPECTED: dict[str, tuple[str, int, str | None]] = {
    ...
    "ft": ("ft", 2, "0.3048"),
    "L": ("L", 2, "1"),
    "gal_us": ("gal", 2, "3.785411784"),
    "gal_uk": ("gal", 2, "4.54609"),
    "l_100km": ("L/100km", 2, "1"),
    "km_l": ("km/L", 2, "100"),
    "mpg_us": ("MPG", 1, "235.2145833333333333333333333"),
    "mpg_uk": ("MPG", 1, "282.4809363318221585938121371"),
    "kpa": ("kPa", 0, "1"),
    "bar": ("bar", 2, "100"),
    "psi": ("PSI", 1, "6.894757293168361336722673445"),
    "c": ("C", 1, "1"),
    "f": ("F", 1, None),
    "kg": ("kg", 2, "1"),
    "lb": ("lb", 2, "0.45359237"),
    "nm": ("Nm", 1, "1"),
    "lbft": ("lb-ft", 1, "1.3558179483314004"),
    "mm": ("mm", 2, "1"),
